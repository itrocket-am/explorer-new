...
<template>
  <div class="bg-gray-100 dark:bg-[#151A30]">
    <!-- sidebar -->
    <div
      class="custom-scrollbar w-64 fixed z-50 left-0 top-0 bottom-0 overflow-auto bg-base-100 border-r border-gray-100 dark:border-gray-700"
    ...
    >
      ...
      <div class="px-2">
        ...
        <a
          href="https://x.com/DigitalMinion2"
          target="_blank"
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
